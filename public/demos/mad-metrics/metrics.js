...
var getMaxScroll = function() {
	...
	for (var i=1;i<percentArray.length; i++){	
...
var secEndPoints = [];
for (var i=0; i < secHeights.length || i< secOffsets.length; i++) {
...
var posTime = [];
for (var i=0; i < secHeights.length || i < secOffsets.length || i < secEndPoints.length; i++) {
    posTime[i] = 0;
}
